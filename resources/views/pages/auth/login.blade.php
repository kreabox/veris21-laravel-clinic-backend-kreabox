...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no"
        name="viewport">
    <title>Login &mdash; Kreabox Clinic</title>
    <!-- General CSS Files -->
    <link rel="stylesheet"
            ...
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-6">
                        ...
                        <h4 class="text-dark font-weight-normal mt-5">Welcome to <span class="font-weight-bold">Kreabox Clinic</span>
                        </h4>
                        ...
                        <form method="POST"
                            ...
                            <div class="form-group text-right">
                                ...
                                <button type="submit"
                                    ...
                                    tabindex="4">
                                    Login <i class="fa fa-sign-in ms-3"></i>
                                </button>
                            </div>
                        ...
                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Kreabox. Made with 💙 by FIC 15 Community
                            <div class="mt-2">
